...
- namu는 **이미 CWS에 공개된 확장** → 공개 확장 제약 준수(민감 키 embed 금지, 데이터수집 신고). Phase 1은 로컬 데이터만 다루므로 무해. (AI 기능은 도입하지 않음 — 사용자 결정 2026-06-09.)
...
- OUT(다음 Phase): 트렌드 히스토리·그래프·워치리스트(P2), 수동 검색 박스(P1.5). **AI 요약은 명시적으로 범위 외 — 사용자 결정(2026-06-09): namu에 AI 기능 미도입.**
...
- ~~Phase 3 (AI "왜 떴나" 요약)~~ — **취소됨. 사용자가 AI 기능 미도입 결정(2026-06-09). namu는 AI 없이 간다.**
